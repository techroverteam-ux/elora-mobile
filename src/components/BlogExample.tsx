...
import EnhancedBlogRenderer from './EnhancedBlogRenderer';
import { BlogCategory } from '../types/blog';

/**
 * Example component demonstrating the Enhanced Blog System
 * This shows how to use the blog renderer with the provided data structure
 */

const BlogExample: React.FC = () => {
  // Example blog data based on the provided structure
  const exampleBlogData: BlogCategory = {
    _id: "693703a7930ad6c8274f90d4",
 ...
 * 
 * const BlogScreen = ({ category, loading }) => {
 *   if (loading) {
 *     return <EnhancedBlogSkeleton sectionsCount={8} />;
 *   }
 *   
 ...
 *   "id": "desc-1",
 *   "type": "description",
 *   "content": "Long form content text...",
 *   "order": 1,
 *   "azureFiles": []
 * }
 * ```
 ...
 *   "order": 2,
 *   "azureFiles": ["https://example.com/image.jpg"]
 * }
 * ```
 * 
 * Image Field (Gallery):
 ...
 *   "order": 4,
 *   "azureFiles": ["https://example.com/video.mp4"]
 * }
 * ```
 * 
 * PDF Field:
 ...
 *   "order": 5,
 *   "azureFiles": ["https://example.com/document.pdf"]
 * }
 * ```
 */