...
const BhajanScreen = () => {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <AppBarHeader title={translateContent('Bhajans')} />
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.headerSection}>
          ...
          <Text style={[styles.headerTitle, { color: colors.onSurface }]}>{translateContent('Divine')} {translateContent('Bhajans')}</Text>
          <Text style={[styles.headerSubtitle, { color: colors.onSurfaceVariant }]}>
            {translateContent('Sacred')} {translateContent('Devotional songs')}
          </Text>
        </View>
