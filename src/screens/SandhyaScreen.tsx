...
const SandhyaScreen = () => {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <AppBarHeader title={translateContent('Sandhya')} />
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.headerSection}>
          ...
          <Text style={[styles.headerTitle, { color: colors.onSurface }]}>{translateContent('Evening')} {translateContent('Sandhya')}</Text>
          <Text style={[styles.headerSubtitle, { color: colors.onSurfaceVariant }]}>
            {translateContent('Sacred')} {translateContent('Prayers')} {translateContent('Meditation')}
          </Text>
        </View>
