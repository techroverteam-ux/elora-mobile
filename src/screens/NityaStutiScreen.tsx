...
const NityaStutiScreen = () => {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <AppBarHeader title={translateContent('Nitya Stuti')} />
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.headerSection}>
          ...
          <Text style={[styles.headerTitle, { color: colors.onSurface }]}>{translateContent('Daily')} {translateContent('Prayers')}</Text>
          <Text style={[styles.headerSubtitle, { color: colors.onSurfaceVariant }]}>
            {translateContent('Sacred')} {translateContent('Daily')} {translateContent('Spiritual practices')}
          </Text>
        </View>
